...
const state = (props) => {
  const initialState = {
    ...
    menus: [
      ...
      { id: 6, href: "testimonials", title: "Research", icon: "presentation" },
    ...
    menus1: [
      ...
      { id: 6, href: "presentation", title: "Research", icon: "presentation" },
      { id: 7, href: "news", title: "Publications", icon: "writing" },
      // { id: 8, href: "faculty", title: "As Faculty", icon: "faculty" },
    ...
    menus3: [
      ...
      { id: 5, href: "presentation", title: "Research", icon: "presentation" },
